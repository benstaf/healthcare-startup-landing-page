  ...
  <section className="contents" id="contents">
    <article className="providers">
      ...
      <div className="providers__text-box">
        ...
        <p>
          We provide the right introduction to the right investor in Asia (Sinovation Ventures, Taiwania Capital...), America (A16Z, ARCH Ventures...), Europe (BPI France, HTGF...), Middle East (PIF, Mubadala...) and elsewhere in the world.
        </p>
